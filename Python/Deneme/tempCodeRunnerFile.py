...
arduino = serial.Serial('COM4', 9600, timeout=1)  # Port numarasını ve baud rate'i uygun şekilde değiştirin
...
while True:
    ...
    if result_frame is not None:
        arduino.write(b'LOGO\n')  # "LOGO" stringini Arduino'ya gönderir
